# Un algoritmo básico de Inteligencia Artificial para resolver cualquier Sudoku
...
Por ello, me he decidido escribir este  post para explicar como es el código de un programa que usa técnicas de inteligencia artificial para resolver un juego como puede ser un _Sudoku_. El sistema que permite la resolución automático de este juego utiliza técnicas parecidas a las que usan los sistemas que resuelven los anteriores juegos mencionados. pero la simplicidad de las reglas, y el hecho que la mayoria de nosotros las conocemos, me facilita poder centrarme en las técnicas de inteligencia artificial usadas sin añadir complejidad por el problema en si mismo. Un _Sudoku_ es básicamente una cuadrícula de 9x9 casillas dividida en regiones de 3x3 casillas, con reglas simples que todos conocemos:
...
Pero no se hagan ilusiones, no por tener reglas simples implica que sea simple su resolución y aun menos rápida. Este agente "inteligente" que les propongo **siempre** (insisto, siempre) va a resolver cualquier Sudoku más rápido que usted, suponiendo que usted pueda resolverlo :-). 

He elegido el lenguage Python para programarlo, pero intentaré explicar los pasos para que se entienda la esencia del algoritmo que usa técnicas clásicas de inteligencia artificial que es independiente de cualquier lenguage de programació. Además, al final, les dejaré el código completo para que aun no sabiendo Python puedan ejecutar el código y superar a cualquiera de sus amigos solo teniendo a mano un un dispositivo electrónico (está instalado por defecto en la mayoria de los ordenadores y se puede descargar como app en cualquier mobil) .
